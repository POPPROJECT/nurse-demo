...
import {
    useState
} from 'react'; // useEffect ไม่จำเป็นแล้วสำหรับ fetchUser
import Link
    from 'next/link';
import Image
    from 'next/image';
...
import ThemeToggle
    from '../ui/ThemeToggle'; // ตรวจสอบ Path ให้ถูกต้อง
import {
    useAuth
            ...
            {isMenuOpen && (
                <div className="absolute w-64 p-4 text-black bg-white border rounded-md shadow-lg top-16 right-4 md:hidden ">
                    <div className="py-2">
                        ...
                        <Link
                            href="/admin/dashboard-subject" // แก้ไข Path นี้ให้ถูกต้องตามที่คุณต้องการ
                            className="flex items-center py-2 space-x-2 rounded-md hover:bg-gray-200"
                        >
                            <TbReportSearch />
                            <span>ภาพรวมความคืบหน้ารายวิชา</span>
                        </Link>
                        ...
                        >
                            <TbReportSearch />
                            <span>ภาพรวมความคืบหน้าตลอดหลักสูตร</span>
                        </Link>
